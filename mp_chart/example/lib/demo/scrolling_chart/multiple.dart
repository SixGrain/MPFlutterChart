...
class ScrollingChartMultipleState
  ...
  Widget _renderItem(int index) {
    ...
    late Chart chart;
    if (controller is LineChartController) {
      chart = _getLineChart(controller);
    } else if (controller is BarChartController) {
      chart = _getBarChart(controller);
    } else if (controller is PieChartController) {
      chart = _getPieChart(controller);
    }
